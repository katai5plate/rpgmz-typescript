...
export default class Utils {
     ...
     */
    static extractFileName: (filename: any) => any;
    /**
     ...
     */
    static containsArabic: (str: any) => boolean;
    constructor();
    /**
     ...
     */
    static isOptionValid(name: string): any;
    /**
